...
Titan.ROUTINE = new MotionRoutine([
	new Motion(Motion.TYPE.ONLY_ONE, '111_7.amc.json', 2, Math.PI / 4).offsetX(0).offsetY(0),
	new Motion(Motion.TYPE.NORMAL, '79_96.amc.json', 1, -Math.PI * .4)
		.shot(TitanShot, ['lradius', 'lwrist', 'lhand', 'lthumb', 'lfingers'], 200), // shot
	new Motion(Motion.TYPE.REWIND, '133_01.amc.json', 2, Math.PI)
		.shot(TitanBullet, ['thorax', 'upperneck'], {min:200, max:550}), // crawl
	new Motion(Motion.TYPE.NORMAL, '79_91.amc.json', 1, -Math.PI * .4)
		.shot(TitanBall, ['rhumerus', 'rradius', 'rwrist', 'rhand'], {min:175, max:200}), // throw
	new Motion(Motion.TYPE.NORMAL, '86_01b.amc.json', 2, Math.PI)
